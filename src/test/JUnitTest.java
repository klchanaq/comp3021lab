...
public class JUnitTest {
	...
	public void testcountLetters() {
		TextNote let1 = new TextNote("","abcdef");
		TextNote let2 = new TextNote("J","1");
		assertEquals("These textnote.countLetters() should return the same char", new Character('a'), let1.countLetters());
