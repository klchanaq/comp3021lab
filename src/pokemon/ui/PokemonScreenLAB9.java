...
public class PokemonScreenLAB9 extends Application {
	...
	//	currentPosy = 0; // this should be a random position
		...
		currentPosx = new java.util.Random().nextInt(W);
		currentPosy = new java.util.Random().nextInt(H);
		
		currentPosx -= currentPosx%STEP_SIZE;
		currentPosy -= currentPosy%STEP_SIZE;
